...
<html>
    ...
    <script language="javascript" charset="utf-8">
        ...
        {
            frm.action = "SolicitacaoAlterarComprovacao.php?alterarRoteiro=1&acao=consultar&cod=<?= $Codigo ?>&recalcular=0";
        ...
        function GravarForm(frm)
        {
            ...
            frm.action = "SolicitacaoAlterarComprovacao.php?acao=AlterarComprovacao";
            frm.submit();
        }
