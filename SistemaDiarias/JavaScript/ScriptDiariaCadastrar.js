                ...
                if (cont == 0) {
                    if (controle != '') {
                        ...
                        if ($('#dataPartida' + controle).val() == $('#dataPartida').val()) {
                            alert('Existe um conflito com a data de saída do roteiro ' + roteiro);
                            return false;
                        }
                        else if ($('#dataChegada' + controle).val() == $('#dataChegada').val()) {
                            alert('Existe um conflito com a data de chegada do roteiro ' + roteiro);
                            return false;
                        }
                    }
                }
...
function CalcularTotalDiarias() {
    ...
    while (controle >= 0) {
        if ($('#roteiroExcluido' + controle).val() != 1) {
            if (controle == 0) {
                ...
                verificaQuantidadeDiaria(qtdeDiaria, controle);
    ...
    if (arrayRoteiro.length >= 1) {
        ordenado = arrayRoteiro.sort(sortfunction);
        console.log(ordenado);
        alert('A quantidade de diárias não pode ultrapassar 5(cinco), altere o '+ordenado[0]+'° roteiro');
        return false;
    }
...
function verificaQuantidadeDiaria(valorQuantidade, roteiro) {
    if (valorQuantidade > 5) {
        controleInteiro = parseInt(roteiro);
        valorRoteiro = controleInteiro + 1;
        arrayRoteiro.push(valorRoteiro);
        console.log(arrayRoteiro+' tamanho do array');
    }
