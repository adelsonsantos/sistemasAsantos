...
<!--
	...
	function GravarForm(frm)
	{
		...
		if (frm.txtCodigo.value == "")
			frm.action = "MeioTransporteCadastrar.php?acao=incluir";
		else
			frm.action = "MeioTransporteCadastrar.php?acao=alterar";
                        	...
                        	<tr>
                            	<td>
                                    <table width="798" border="0" cellpadding="0" cellspacing="1">
                                        ...
                                        <tr height="21">
                                            <td class="dataField">&nbsp;<input name="txtDescricao" maxlength="100" type="text" value="<?=$Descricao?>" style=" width:265px;">&nbsp;*</td>
                                        </tr>
                                    </table>
 								</td>
                        	</tr>
