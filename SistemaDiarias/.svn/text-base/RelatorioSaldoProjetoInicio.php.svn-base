...
<!--
	...
	function GerarRelatorio(frm)
	{
		...
		if (frm.txtDataComprova.value == "")
		{
			alert("Infome a Data limite!");
			frm.txtDataComprova.focus();
			frm.txtDataComprova.style.backgroundColor='#B9DCFF';
			return false;
		}
		
			frm.action = "RelatorioSaldoProjetoPDF.php";
			frm.submit();
	}
-->
</script>
								...
								<td>
									<table border="0" cellpadding="1" cellspacing="1" width="798">
										<tr height="20">
											...
											<td width="75" class="dataField">&nbsp;<input type="text" name="txtDataComprova" value="" style="width:66px;" readonly></td>
											<td width="" class="dataField"><a href="#" onClick="javascript:displayCalendar(txtDataComprova,'dd/mm/yyyy',this);"><img src="../Icones/ico_calendario.gif" border="0" align="Mostrar Calend&acute;rio" width="18" height="18"></a></td>
									 </tr>
									</table>
