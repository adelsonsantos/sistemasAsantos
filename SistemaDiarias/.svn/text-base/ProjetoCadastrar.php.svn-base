...
<!--
	...
	function GravarForm(frm)
	{
		...
		if (frm.txtCodigo.value == "")
			frm.action = "ProjetoCadastrar.php?acao=incluir";
		else
			frm.action = "ProjetoCadastrar.php?acao=alterar";
                            	...
                            	<td>
                                    <table width="798" border="0" cellpadding="0" cellspacing="1">
                                        <tr height="21">
                                            ...
                                            <td class="dataLabel" width="130">&nbsp;Saldo R$</td>
...
?>
                                            <td class="dataField">&nbsp;<input name="txtSaldo" maxlength="10" type="text" value="<?=$Saldo?>" style=" width:100px;" onKeyPress="return(MascaraMoeda(this,'.',',',event))"></td>
                                            <td class="dataField">&nbsp;<input name="txtDescricao" maxlength="350" type="text" value="<?=$Descricao?>" style=" width:500px;">&nbsp;*</td>
                                        </tr>
                                    </table>
 								</td>
                        	</tr>
