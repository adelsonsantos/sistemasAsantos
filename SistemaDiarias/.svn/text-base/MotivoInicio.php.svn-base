...
<!--
	...
	function FiltrarForm(frm)
	{
		...
		frm.action = "MotivoInicio.php?acao=buscar";
		frm.submit();
	}
	...
	function ExcluirForm(frm, checkbox)
	 {
		...
		frm.action="MotivoExcluir.php?excluirMultiplo=1";
		frm.submit();
	 }
	...
	function AlterarForm(frm, checkbox)
	 {
		...
		frm.action="MotivoCadastrar.php?acao=consultar";
		frm.submit();
	 }
                                ...
                                <td>
                                    <table border="0" cellpadding="1" cellspacing="1">
                                        <tr height="20" class="GridPaginacaoRegistroCabecalho">
                                            ...
                                            <td width="190" align="left">&nbsp;Tipo</td>
...
<?
														echo "<td class='GridPaginacaoLink'>&nbsp;" .$MotivoTipoNome. "</td>";
														echo "<td class='GridPaginacaoLink'>&nbsp;" .$Descricao."</td>";
														echo "<td class='GridPaginacaoLink' align='center'><a href=MotivoInicio.php?acao=alterarStatus&cod=".$Codigo. "&status=" .$StatusNumero. "><font color='#065387'>" .$StatusNome. "</font></a></td>";
														echo "</tr>";
