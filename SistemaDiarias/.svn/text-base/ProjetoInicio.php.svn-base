...
include "Classe/ClasseProjeto.php";
?>
<html>
...
<!--
	...
	function FiltrarForm(frm)
	{
		...
		frm.action = "ProjetoInicio.php?acao=buscar";
		frm.submit();
	}
	...
	function ExcluirForm(frm, checkbox)
	 {
		...
		frm.action="ProjetoExcluir.php?excluirMultiplo=1";
		frm.submit();
	 }
                                ...
                                <td>
                                    <table border="0" cellpadding="1" cellspacing="1">
                                        <tr height="20" class="GridPaginacaoRegistroCabecalho">
                                            ...
                                            <td width="468" align="left">&nbsp;Descri&ccedil;&atilde;o</td>
...
<?
									   ...
									   $paginaAtual =(int) $_GET['PaginaMostrada'];
										...
										{       $linha=pg_fetch_assoc($rsConsulta,$qtdIndice);
                                                ...
                                                $Codigo			= $linha['projeto_cd'];
                                                $Saldo			= $linha['projeto_saldo'];
                                                $Descricao	   	= $linha['projeto_ds'];
                                                $StatusNumero	= $linha['projeto_st'];
...
<?
                                                ...
                                                echo "<td class='GridPaginacaoLink' align='center'>".$Saldo. "</td>";
                                                echo "<td class='GridPaginacaoLink'>&nbsp;" .substr($Descricao,0,60)."</td>";
                                                echo "<td class='GridPaginacaoLink' align='center'><a href=ProjetoInicio.php?acao=alterarStatus&cod=".$Codigo. "&status=" .$StatusNumero. "><font color='#065387'>".$StatusNome."</font></a></td>";
                                                echo "</tr>";
