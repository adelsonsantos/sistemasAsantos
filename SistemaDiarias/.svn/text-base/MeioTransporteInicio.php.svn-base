...
<!--
	...
	function FiltrarForm(frm)
	{
		...
		frm.action = "MeioTransporteInicio.php?acao=buscar";
		frm.submit();
	}
	...
	{
		frm.txtFiltro.value = "";
		frm.action = "MeioTransporteInicio.php";
		frm.submit();
	}
	...
	function ExcluirForm(frm, checkbox)
	 {
		...
		frm.action="MeioTransporteExcluir.php?excluirMultiplo=1";
		frm.submit();
	 }
	...
	function AlterarForm(frm, checkbox)
	 {
		...
		frm.action="MeioTransporteCadastrar.php?acao=consultar";
		frm.submit();
	 }
...
<?
														...
														echo "<td class='GridPaginacaoLink' align='center'><a href=MeioTransporteInicio.php?acao=alterarStatus&cod=".$Codigo."&status=".$StatusNumero."><font color='#065387'>".$StatusNome."</font></a></td>";
														echo "</tr>";
