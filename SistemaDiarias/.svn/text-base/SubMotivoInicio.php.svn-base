...
include "Classe/ClasseSubMotivo.php";
?>
<html>
...
<!--
	...
	function FiltrarForm(frm)
	{
		...
		frm.action = "SubMotivoInicio.php?acao=buscar";
		frm.submit();
	}
	...
	{
		frm.txtFiltro.value = "";
		frm.action = "SubMotivoInicio.php";
		frm.submit();
	}
	...
	function ExcluirForm(frm, checkbox)
	 {
		...
		frm.action="SubMotivoExcluir.php?excluirMultiplo=1";
		frm.submit();
	 }
	...
	function AlterarForm(frm, checkbox)
	 {
		...
		frm.action="SubMotivoCadastrar.php?acao=consultar";
		frm.submit();
	 }
                                ...
                                <td>
                                    <table border="0" cellpadding="1" cellspacing="1">
                                        <tr height="20" class="GridPaginacaoRegistroCabecalho">
                                            ...
                                            <td width="658" align="left">&nbsp;Descri&ccedil;&atilde;o</td>
...
<?
														...
														echo "<td class='GridPaginacaoLink' align='center'><a href=SubMotivoInicio.php?acao=alterarStatus&cod=".$Codigo."&status=" .$StatusNumero."><font color='#065387'>".$StatusNome."</font></a></td>";
														echo "</tr>";
