...
<!--
	...
	function GravarForm(frm)
	{
		...
		{
			alert("Campo N&Uacute;MERO em Branco.");
			frm.txtNumero.focus();
		...
		{
			alert("Campo DESCRI&Ccedil;&Atilde;O em Branco.");
		...
		if (frm.txtCodigo.value == "")
			frm.action = "TerritorioCadastrar.php?acao=incluir";
		else
			frm.action = "TerritorioCadastrar.php?acao=alterar";
                            	...
                            	<td>
                                    <table width="798" border="0" cellpadding="0" cellspacing="1">
                                        <tr height="21">
                                            ...
                                            <td class="dataLabel" width="698">&nbsp;Descri&ccedil;&atilde;o</td>
                                        </tr>
                                        <tr height="21">
<?
											If ($Numero != "")
                                            {
?>
                                            	<td class="dataField">&nbsp;<input name="txtNumero" maxlength="3" type="text" value="<?=$Numero?>" style=" width:50px;" readonly class="Oculto">&nbsp;*</td>
<?											}
											Else
                                            {
?>
                                            	<td class="dataField">&nbsp;<input name="txtNumero" maxlength="3" type="text" value="<?=$Numero?>" style=" width:50px;">&nbsp;*</td>
<?
                                            }
?>
