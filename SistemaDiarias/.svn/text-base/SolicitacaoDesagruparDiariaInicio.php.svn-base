                                                    ...
                                                    <?php
                                                        for ($index = 0; $index < count($agrupamentos); $index++) { ?>
                                                            <tr height='20' bgcolor='#F5DEB3' class='GridPaginacaoLink'>
                                                                <td align='center' style="width: 30px;"><a href='SolicitacaoDesagruparDiaria.php?acao=ssd&ssd=<?php echo $agrupamentos[$index]->super_sd; ?>'><img src='../Icones/ico_consultar.png' border='0' alt='Consultar'></a></td>
