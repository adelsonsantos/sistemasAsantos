...
<?
										...
										If ($ExcluirCheckbox == 1)
                                        {
											...
											$sqlConsulta = "SELECT * FROM diaria.sub_motivo WHERE sub_motivo_id IN (" .$codCheckbox.") ORDER BY UPPER(sub_motivo_ds)";
