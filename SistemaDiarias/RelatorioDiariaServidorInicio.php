                                        ...
                                        <tr>
                                            <td>
                                                <table border="0" cellpadding="1" cellspacing="1" width="798">
                                                    <tr class="dataLabel">
                                                        <td height="20" width="130">Selecione o Servidor:</td>
                                                        <td height="20" width="395">
                                                            <?php ComboBeneficiario('todos', '');?>
                                                        </td>
                                                        <td height="20" width="75">Relat&oacute;rio:</td>                                                        
                                                        <td height="20" width="198">
                                                            <input id="radioAnual" type="radio" class="radio" name="radioTipo" style="width:10px; height:10px;" value="Ano" onClick="HabCombo()" /> Por Ano
                                                            <input id="radioPeriodo" type="radio" class="radio" name="radioTipo" style="width:10px; height:10px;" value="Periodo" onClick="HabCombo()" />Por Per&iacute;odo
                                                        </td>                                                        
                                                    </tr>
                                                </table>
                                                <table border="0" cellpadding="1" cellspacing="1" width="798">
