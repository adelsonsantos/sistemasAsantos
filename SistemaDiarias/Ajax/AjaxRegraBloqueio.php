...
if($qtdSomaMes >= 15)
{
    ...
    } elseif($Beneficiario == 1628 || $Beneficiario == 2233 || $Beneficiario == 2303 || $Beneficiario == 1066 || $Beneficiario == 1869 || $Beneficiario == 1567 || $Beneficiario == 1550 || $Beneficiario == 2219 || $Beneficiario == 1788 || $Beneficiario == 1644 || $Beneficiario == 1247 || $Beneficiario == 5588 || $Beneficiario == 1190){
        if($qtdSomaMes >= 20){
            $PossuiBloqueio = 1;
