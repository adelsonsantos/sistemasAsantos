...
<head>
    ...
    <meta name="Keywords"
          content="ADAB, Ag&ecirc;ncia de Defesa Agropecu&aacute;ria da Bahia, Defesa Agropecu&aacute;ria, Agropecu&aacute;ria Bahia"/>
        ...
        <tr>
            <td height="21">
                <table align="left" width="990" cellspacing="0" cellpadding="1" border="0">
                    <tr>
                        <td height="21" width="190" valign="top"
                            align="left"><?php include "../Include/Inc_Menu.php" ?></td>
                        <td height="21" valign="top" align="left">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                    ...
                                    <td height="21">
                                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                            <tr>
                                                    ...
                                                    <table cellpadding="0" width="100%" cellspacing="0" border="0"
                                                        ...
                                                        <tr>
                                                            <td width="7" align="left"
                                                                background="../Imagens/bgaba_on.gif"><img
                                                                        src="../Imagens/aba_esq_on.gif" width="7"
                                                                        height="18" alt=""/></td>
                                                            <td background="../Imagens/bgaba_on.gif" align="center"
                                                                class="linktab" width="160">Di&aacute;ria
                                                            </td>
                                                            <td width="7" align="right"
                                                                background="../Imagens/bgaba_on.gif"><img
                                                                        src="../Imagens/aba_dir_on.gif" width="7"
                                                                        height="18" alt=""/></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                <td width="1"><img src="../Imagens/separa_aba.gif" width="1" height="18"
                                                                   alt=""/></td>
                                                <td>
                                                    <table cellpadding="0" width="100%" cellspacing="0" border="0"
                                                           id="aba1_off" style="cursor:hand;display:none">
                                                        <tr>
                                                            <td width="7" align="left"
                                                                background="../Imagens/bgaba_off.gif"><img
                                                                        src="../Imagens/aba_esq_off.gif" width="7"
                                                                        height="18" alt=""/></td>
                                                            <td background="../Imagens/bgaba_off.gif" align="center"
                                                                width="160"><a class="linktab" href="#" onclick="mostra_obj_id(aba1_on); esconde_obj_id(aba1_off); mostra_obj_id(formaba1);
                                                                        mostra_obj_id(aba2_off); esconde_obj_id(aba2_on); esconde_obj_id(formaba2);
                                                                        //mostra_obj_id(aba3_off); esconde_obj_id(aba3_on); esconde_obj_id(formaba3);">Di&aacute;ria</a>
                                                            </td>
                                                            <td width="7" align="right"
                                                                background="../Imagens/bgaba_off.gif"><img
                                                                        src="../Imagens/aba_dir_off.gif" width="7"
                                                                        height="18" alt=""/></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                ...
                                                <td>
                                                    <table cellpadding="0" width="100%" cellspacing="0" border="0"
                                                           id="aba2_on" style="cursor:hand;display:none">
                                                        <tr>
                                                            <td width="7" align="left"
                                                                background="../Imagens/bgaba_on.gif"><img
                                                                        src="../Imagens/aba_esq_on.gif" width="7"
                                                                        height="18" alt=""/></td>
                                                            <td background="../Imagens/bgaba_on.gif" align="center"
                                                                class="linktab" width="160">Projeto
                                                            </td>
                                                            <td width="7" align="right"
                                                                background="../Imagens/bgaba_on.gif"><img
                                                                        src="../Imagens/aba_dir_on.gif" width="7"
                                                ...
                                                <td>
                                                    <table cellpadding="0" width="100%" cellspacing="0" border="0"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td background="../Imagens/bgaba_off.gif" align="center"
                                                                width="160"><a class="linktab" href="#" onClick="esconde_obj_id(aba1_on); mostra_obj_id(aba1_off); esconde_obj_id(formaba1);
                                                                        //esconde_obj_id(aba3_on); mostra_obj_id(aba3_off); esconde_obj_id(formaba3);
                                                                        esconde_obj_id(aba2_off); mostra_obj_id(aba2_on); mostra_obj_id(formaba2);">Projeto</a>
                                                            </td>
                                                ...
                                                <td width="1"><img id="IMG_Seperacao" src="../Imagens/separa_aba.gif"
                                                                   style="width:440px;" height="18" alt=""/></td>
                                            </tr>
                                ...
                                <tr>
                                    <td align="center" class="tabFiltro"><img src="../Imagens/vazio.gif" width="1"
                                                                              height="10" alt=""/></td>
                                </tr>
                            </table>
                            <?php include "../Include/Inc_Linha.php" ?>
                            ...
                            <div id="formaba1" style="display:block">
                                        ...
                                        <td>
                                            <table width="800" border="0" cellpadding="0" cellspacing="1">
                                                <tr class="dataLabel">
                                                    ...
                                                    <td height="21">
                                                        <input type="radio" class="radio" id="radioCapital"
                                                               name="radioCoordenadoria"
                                                               value="Sede" <?= $checkCaptal ?>
                                                               onclick="HabCoordenadoria()"/>Sede&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                        <input type="radio" class="radio" id="radioInterior"
                                                               name="radioCoordenadoria"
                                                               value="Coordenadoria" <?= $checkInterior ?>
                                                               onclick="HabCoordenadoria()"/>Coordenadoria&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                ...
                                                <tr class="dataField">
                                                    ...
                                                    <td height="21">
                                                        &nbsp;<?= ComboBeneficiario($linhaDiaria['diaria_beneficiario'], "onChange=Javascript:ConsultaValorRef('','');PedeNovoCalculo('');") ?>
                                                        &nbsp;*
                                                    </td>
                                                </tr>
                                            </table>
                                ...
                                <div id="roteiroAdicional">
                                    <div id="mostrar0" onclick="Javascript:ExpandirRoteiro(0)" style="display: none">
                                        <table cellpadding="0" cellspacing="1" class="TabelaFormulario" border="0"
                                               width="100%">
                                            <tr class="dataTitulo">
                                                <td height="21" width="50%">&nbsp;1º Roteiro <span
                                                            id="roteiroExMsg0"></span><input id="roteiroExcluido0"
                                                                                             name="roteiroExcluido0"
                                                                                             type="hidden"></input><input
                                                            type='hidden' id='qtdeRoteiros' name='qtdeRoteiros'
                                                            value=''/></td>
                                    ...
                                    <div id="roteiroAdicional0">
                                        <input type="hidden" name="txtAlterouCalculo" id="txtAlterouCalculo"
                                               value="<?= $alterouCalculo ?>"/>
                                                ...
                                                <td>
                                                    <table cellpadding="0" cellspacing="1" border="0" width="100%">
                                                        <tr class="dataTitulo">
                                                            ...
                                                            <td height="21" width="50%" align="right"><span
                                                                        id="minimizarRoteiro0"
                                                                        onclick="Javascript:EsconderRoteiro(0)"
                                                                        style="display: none"><big>-</big>  /+</span>
                                                            </td>
                                                        </tr>
                                                        <tr class="dataLabel">
                                                                            ...
                                                                            <tr>
                                                                                    ...
                                                                                    <table cellpadding="0"
                                                                                        ...
                                                                                        <tr class="dataField">
                                                                                            <td height="21" width="50">
                                                                                                &nbsp;<?= f_ComboEstado("cmbRoteiroOrigemUF", "onChange='Javascript:MudaComboCidadeOrigem(\"\",\"\");'", "") ?></td>
                                                                                            <td height="21"><span
                                                                                                        id="RoteiroOrigem"><?= f_ComboMunicipio("cmbRoteiroOrigemMunicipio", "", "") ?></span>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                                </td>
                                                                                <td height="21" class="dataField">
                                                                                    <table cellpadding="0"
                                                                                        ...
                                                                                        <tr class="dataField">
                                                                                            <td height="21" width="50">
                                                                                                &nbsp;<?= f_ComboEstado("cmbRoteiroDestinoUF", "onChange='Javascript:MudaComboCidadeDestino(\"\",\"\");'", "") ?></td>
                                                                                            <td height="21">
                                                                                            ...
                                                                                            <td height="21">
                                                                                                <input type="button"
                                                                                                       ...
                                                                                                       value="Adicionar"
                                                                                                       onclick="Javascript:AdicionarDadosRoteiro('');"/>
                                                                                                &nbsp;
                                                                                                <input type="button"
                                                                                                       name="btnLimpar"
                                                                                                       id="btnLimpar"
                                                                                                       value="Limpar"
                                                                                                       style="width:65px; height:18px;"
                                                                                                       onclick="Javascript:LimparDadosRoteiro('');"/>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                                </td>
                                                    ...
                                                    <table width="800" border="0" cellpadding="0" cellspacing="1">
                                                        <tr>
                                                            <td height="21" colspan="8" class="dataLabel">&nbsp;Complemento
                                                                do Roteiro
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td height="21" colspan="8" class="dataField">&nbsp;<input
                                                                        type="text" name="txtRoteiroComplemento"
                                                                        id="txtRoteiroComplemento" style="width:750px;"
                                                                        maxlength="120"
                                                                        value="<?= $linhaDiaria['diaria_roteiro_complemento']; ?>"/>
                                                            </td>
                                                        </tr>
                                                        <tr class="dataTitulo">
                                                            <td height="21" width="399" colspan="4">&nbsp;Partida
                                                                Prevista
                                                            </td>
                                                            <td height="21" width="399" colspan="4">&nbsp;Chegada
                                                                Prevista
                                                            </td>
                                                        </tr>
                                                        <tr class="dataLabel">
                                                        ...
                                                        <tr class="dataField">
                                                            <td height="21" width="80"><input id="dataPartida"
                                                                                              type="text"
                                                                                              name="txtDataPartida"
                                                                                              maxlength="10"
                                                                                              style=" width:75px;height:15px;"
                                                                                              value="<?= $linhaDiaria['diaria_dt_saida'] ?>"
                                                                                              onchange="computeControle(this,1,'');PedeNovoCalculo('');"/>
                                                            </td>
                                                            <td height="21" width="20"><a href="#"
                                                                                          onclick="javascript:displayCalendar(document.getElementById('dataPartida'),'dd/mm/yyyy',this);"><img
                                                                            src="../Icones/ico_calendario.gif"
                                                                            border="0" align="Mostrar Calendário"
                                                                            width="18"/></a></td>
                                                            <td height="21" width="100"><input id="horaPartida"
                                                                                               type="text"
                                                                                               name="txtHoraPartida"
                                                                                               maxlength="5"
                                                                                               style=" width:75px;height:15px;"
                                                                                               onkeyup="mascaraHora(this.value, document.Form.txtHoraPartida);PedeNovoCalculo('');"
                                                                                               onkeypress="mascaraNumero(event, this);"
                                                                                               value="<?= $linhaDiaria['diaria_hr_saida'] ?>"
                                                                                               onchange="PedeNovoCalculo('');"/>
                                                            </td>
                                                            <td height="21" width="199"><input id="diaPartida"
                                                                                               type="text"
                                                                                               name="txtPartidaSemana"
                                                                                               class="Oculto"
                                                                                               value="<?= $diaSemanaPartida ?>"/>
                                                            </td>
                                                            <td height="21" width="80"><input id="dataChegada"
                                                                                              type="text"
                                                                                              name="txtDataChegada"
                                                                                              maxlength="10"
                                                                                              style="width:75px;height:15px;"
                                                                                              value="<?= $linhaDiaria['diaria_dt_chegada'] ?>"
                                                                                              onchange="computeControle(this,2,'');PedeNovoCalculo('')"/>
                                                            </td>
                                                            <td height="21" width="20"><a href="#"
                                                                                          onclick="javascript:displayCalendar(document.getElementById('dataChegada'),'dd/mm/yyyy',this);"><img
                                                                            src="../Icones/ico_calendario.gif"
                                                                            border="0" align="Mostrar Calendário"
                                                                            width="18"/></a></td>
                                                            <td height="21" width="100">&nbsp;<input id="horaChegada"
                                                                                                     type="text"
                                                                                                     name="txtHoraChegada"
                                                                                                     maxlength="5"
                                                                                                     style=" width:75px;height:15px;"
                                                                                                     onkeyup="mascaraHora(this.value, document.Form.txtHoraChegada);PedeNovoCalculo('');"
                                                                                                     onkeypress="mascaraNumero(event, this);"
                                                                                                     value="<?= $linhaDiaria['diaria_hr_chegada'] ?>"
                                                                                                     onchange="PedeNovoCalculo('');"/>
                                                            </td>
                                                            <td height="21" width="199">&nbsp;<input id="diaChegada"
                                                                                                     type="text"
                                                                                                     name="txtChegadaSemana"
                                                                                                     class="Oculto"
                                                                                                     value="<?= $diaSemanaChegada ?>"/>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <table width="100%" border="0" cellpadding="0" cellspacing="1">
                                                        <tr class="dataLabel">
                                                            <td height="21" width="100">&nbsp;Redu&ccedil;&atilde;o
                                                                50%
                                                            </td>
                                                            <td height="21" width="181">&nbsp;Valor Refer&ecirc;ncia
                                                        ...
                                                        <tr class="dataField">
                                                            ...
                                                            ?>
                                                            <td height="21" width="100">&nbsp;<input type="checkbox"
                                                                                                     name="chkDesconto"
                                                                                                     id="chkDesconto"
                                                                                                     class="checkbox" <?= $descontoMarcado ?>
                                                                                                     onchange="PedeNovoCalculo('');"/>&nbsp;Sim
                                                            </td>
                                                            <td height="21" width="181" valign="middle">
                                                                <div id="ValorRef">
                                                                    <input type="hidden" name="txtValorReferencia"
                                                                           id="txtValorReferencia"
                                                                           value="<?= $linhaDiaria['diaria_valor_ref'] ?>"
                                                                           style="width:75px; height:18px;"></input>
                                                                </div>
                                                            </td>
                                                            <td height="21" width="330" colspan="3" valign="middle">
                                                                <div id="QtdeDiariaAlterar" style='display:none'>
                                                                    <table width="100%" border="0" cellpadding="0"
                                                                           cellspacing="1">
                                                                        <tr class="dataField">
                                                                            <td height="21" width="116">
                                                                                &nbsp;<?= '+' . $percentualImprimir . '%  R$ ' . number_format($linhaDiaria['diaria_valor_ref'], 2, ',', '.') ?></td>
                                                                            <td height="21" width="104"><input
                                                                                        disabled="disabled" type="text"
                                                                                        id="qtdeDiaria"
                                                                                        name="qtdeDiaria"
                                                                                        value="<?= $linhaDiaria['diaria_qtde'] ?>"
                                                                            ...
                                                                            <td height="21" width="110"><input
                                                                                        disabled="disabled" type="text"
                                                                                        id="valorDiaria"
                                                                                        name="valorDiaria"
                                                                                        value="<?= 'R$ ' . number_format($linhaDiaria['diaria_valor'], 2, ',', '.') ?>"
                                                                                        style='width:70px;'/><input
                                                                                        id="hdValorDiaria"
                                                                                        name="hdValorDiaria"
                                                                                        type="hidden"
                                                                                        value="<?= $linhaDiaria['diaria_valor'] ?>"/>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </div>
                                                            ...
                                                            <td height="21" width="139"><input id="calcular"
                                                                                               type="button"
                                                                                               name="btnCalcular"
                                                                                               style="width:125px;height:18px;"
                                                                                               value="Calcular Di&aacute;ria"
                                                                                               onclick="CalcularDiaria($('#dataPartida').val(), $('#dataChegada').val(), $('#horaPartida').val(), $('#horaChegada').val(), $('#cmbBeneficiario').val(), $('#chkDesconto').is(':checked'), $('#txtDataAtual').val(), '');"/>
                                                            </td>
                                                            <?php
                                                            if (($codigo != '') && ($controleRoteiro == 0)) {
                                                                ...
                                                                ?>
                                                                <td height="21" width="25" align="right"><span
                                                                            id="btnRemover0" style="display: none;"><a
                                                                                onclick="RemoverRoteiro('');"><img
                                                                                    alt=""
                                                                                    src="../Icones/ico_excluir.png"
                                                                                    width="18"
                                                                                    title="Remover roteiro."/></a></span>
                                                                </td>
                                                                <td height="21" width="25" align="right"><span
                                                                            id="btnAdicionarRoteiro"><a
                                                                                onclick="RoteiroAdicional('');"><img
                                                                                    alt=""
                                                                                    src="../Icones/ico_adicionar2.png"
                                                                                    width="18"
                                                                                    title="Adicionar novo roteiro."/></a></span>
                                                                </td>
                                                                <?php
                                                            } ?>
                                                        </tr>
                                        ...
                                        <input type="hidden" id="calculo" name="Calculo"
                                               value="<?= $diariaCalculada ?>"/>
                                    </div>
                                    <input type="hidden" id="controleRoteiro" name="controleRoteiro"
                                           value="<?= $controleRoteiro ?>"/>
                                    <?php include "../Include/Inc_Linha.php" ?>
                                    <div id="mostrar1" onclick="Javascript:ExpandirRoteiro(1)"
                                         style="display: none"></div>
                                    <div id="roteiroAdicional1"></div>
                                    <div id="espaco1"></div>
                                    <div id="mostrar2" onclick="Javascript:ExpandirRoteiro(2)"
                                         style="display: none"></div>
                                    <div id="roteiroAdicional2"></div>
                                    <div id="espaco2"></div>
                                    <div id="mostrar3" onclick="Javascript:ExpandirRoteiro(3)"
                                         style="display: none"></div>
                                    <div id="roteiroAdicional3"></div>
                                    <div id="espaco3"></div>
                                    <div id="mostrar4" onclick="Javascript:ExpandirRoteiro(4)"
                                         style="display: none"></div>
                                    <div id="roteiroAdicional4"></div>
                                    <div id="espaco4"></div>
                                    <div id="mostrar5" onclick="Javascript:ExpandirRoteiro(5)"
                                         style="display: none"></div>
                                    <div id="roteiroAdicional5"></div>
                                    <div id="espaco5"></div>
                                    <div id="mostrar6" onclick="Javascript:ExpandirRoteiro(6)"
                                         style="display: none"></div>
                                ...
                                <div id="calculoRoteiroAdicional" style="display: none;">
                                    <table width="800" border="0" cellpadding="0" cellspacing="1">
                                        <tr>
                                            <td align="right">
                                                <input type="button" id="calcularRoteiro" name="btnCalcularRoteiro"
                                                       style="width:140px;height:18px;"
                                                       value="Calcular Total de Diárias"
                                                       onclick="CalcularTotalDiarias();"/>
                                                <input type="hidden" id="calculoTotalDiarias" name="calculoTotalDiarias"
                                                       value="0"/>
                                            </td>
                                        </tr>
                                    </table>
                                    ...
                                    <tr>
                                        <td height="21">
                                            <table width="100%" border="0" cellpadding="0" cellspacing="1">
                                                <tr class="dataLabel">
                                                    <td height="21">
                                                        <table width="100%" cellpadding="0" cellspacing="1" border="0">
                                                            <tr>
                                                                <td height="21" width="50%" class="dataLabel">&nbsp;Justificativa
                                                                    do Final de Semana
                                                                </td>
                                                                <td height="21" width="50%" class="dataLabelSemBold"
                                                                    align="right">M&aacute;ximo permitido 255 caracteres&nbsp;<input
                                                                            type="text" id="QtdFimSemana"
                                                                            name="QtdFimSemana" style=" width:35px;"
                                                                            class="Oculto"/>&nbsp;
                                                                </td>
                                                            </tr>
                                                        </table>
                                                ...
                                                <tr class="dataField">
                                                    <td height="21">&nbsp;<textarea name="txtJustificativaFimSemana"
                                                                                    id="txtJustificativaFimSemana"
                                                                                    style=" width:789px; height:45px"
                                                                                    maxlenght="255"
                                                                                    onKeyUp="ContarJustificativaFimSemana(this,255)"><?= $linhaDiaria['diaria_justificativa_fds'] ?></textarea>
                                                    </td>
                                                </tr>
                                            </table>
                                            <table width="100%" border="0" cellpadding="0" cellspacing="1">
                                                    ...
                                                    <td height="21">
                                                        <table width="100%" cellpadding="0" cellspacing="1" border="0">
                                                            <tr>
                                                                ...
                                                                <td height="21" width="50%" class="dataLabelSemBold"
                                                                    align="right">M&aacute;ximo permitido 255 caracteres&nbsp;<input
                                                                            type="text" id="QtdFeriado"
                                                                            name="QtdFeriado" style=" width:35px;"
                                                                            class="Oculto"/>&nbsp;
                                                                </td>
                                                            </tr>
                                                        </table>
                                                ...
                                                <tr class="dataField">
                                                    <td height="21">&nbsp;<textarea name="txtJustificativaFeriado"
                                                                                    id="txtJustificativaFeriado"
                                                                                    style=" width:789px; height:45px"
                                                                                    maxlenght="255"
                                                                                    onKeyUp="ContarJustificativaFeriado(this,255)"><?= $linhaDiaria['diaria_justificativa_feriado'] ?></textarea>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                    ...
                                    <tr>
                                        <td height="21">
                                            <table width="100%" border="0" cellpadding="0" cellspacing="1">
                                                ...
                                                <tr class="dataField">
                                                    <td height="21">
                                                        &nbsp;<?= f_ComboMeioTransporte($linhaDiaria['meio_transporte_id']) ?></td>
                                                    <td height="21">&nbsp;<input name="txtMeioTransporteObservacao"
                                                                                 id="txtMeioTransporteObservacao"
                                                                                 maxlength="255" type="text"
                                                                                 value="<?= $linhaDiaria['diaria_transporte_obs'] ?>"
                                            ...
                                            <table width="100%" border="0" cellpadding="0" cellspacing="1">
                                                ...
                                                <tr class="dataField">
                                                    <td height="21">
                                                        &nbsp;<?= ComboMotivoDiaria($linhaDiaria['motivo_id'], 3, "") ?></td>
                                                    <td height="21">
                                                        &nbsp;<?= ComboSubMotivoDiaria($linhaDiaria['sub_motivo_id']) ?></td>
                                                </tr>
                                            </table>
                                            <table width="100%" border="0" cellpadding="0" cellspacing="1">
                                                <tr class="dataLabel">
                                                    <td height="21">
                                                        <table width="100%" cellpadding="0" cellspacing="1" border="0">
                                                            <tr>
                                                                <td height="21" width="50%" class="dataLabel">&nbsp;Detalhe
                                                                    do Motivo
                                                                </td>
                                                                <td height="21" width="50%" class="dataLabelSemBold"
                                                                    align="right">M&aacute;ximo permitido 300 caracteres&nbsp;<input
                                                                            type="text" id="QtdDescricao"
                                                                            name="QtdDescricao" style=" width:35px;"
                                                                            readonly class="Oculto"/>&nbsp;
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                ...
                                                <tr class="dataField">
                                                    <td height="21">&nbsp;<textarea name="txtDescricao"
                                                                                    id="txtDescricao"
                                                                                    style=" width:789px; height:45px"
                                                                                    maxlenght="300"
                                                                                    onKeyUp="ContarDescricao(this,300)"><?= $linhaDiaria['diaria_descricao'] ?></textarea>
                                                    </td>
                                                </tr>
                                            </table>
                                            <table width="100%" border="0" cellpadding="0" cellspacing="1">
                                                ...
                                                <tr class="dataField">
                                                    <td height="21">
                                                        &nbsp;<?= ComboACP($linhaDiaria['diaria_unidade_custo'], "onChange=MandaID(this.value,'AjaxProjeto')") ?></td>
                                                </tr>
                                                <tr class="dataLabel">
                                                ...
                                                <tr class="dataField">
                                                    <td height="21">
                                                        <div id="Projeto">
                                                            &nbsp<?= f_ComboProjeto($linhaDiaria['projeto_cd'], "onChange=MandaID(this.value,'AjaxAcao','projeto_cd')") ?></div>
                                                    </td>
                                                </tr>
                                                <tr class="dataLabel">
                                                ...
                                                <tr class="dataField">
                                                    ...
                                                    <?php } else { ?>
                                                        <td height="21">
                                                            <div id="Territorio">
                                                                &nbsp;<?= f_ComboTerritorio('', '', "disabled", "785") ?></div>
                                                        </td>
                                                    <?php } ?>
                                                </tr>
                                                <tr class="dataLabel">
                                                ...
                                                <tr class='dataLabel'>
                                                    <td height='21'><span id="desEtapa"
                                                                          style="display:none">&nbsp;Etapa</span></td>
                                                </tr>
                                                <tr class='dataField'>
                                                    <td height='21'>&nbsp;
                                                        <span id="spEtapa"
                                                              style="display:none"><?= f_ComboEtapas('cmbEtapa', '783', $linhaDiaria['etapa_id'], 'onchange="VerificaSaldoEtapa()"', '114', $linhaDiaria['projeto_cd'], $linhaDiaria['fonte_cd']); ?></span>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                            ...
                            <input name="txtStatus" id="txtStatus" type="hidden"
                                   value="<?= $linhaDiaria['diaria_st'] ?>"/>
                            <input name="txtNumero" id="txtNumero" type="hidden"
                                   value="<?= $linhaDiaria['diaria_numero'] ?>"/>
                            <input name="txtValor" id="txtValor" type="hidden"
                                   value="<?= $linhaDiaria['diaria_valor'] ?>"/>
                            <input name="txtFonte" id="txtFonte" type="hidden" value="<?= $linhaDiaria['fonte_cd'] ?>"/>
                            <input name="txtProjeto" id="txtProjeto" type="hidden"
                                   value="<?= $linhaDiaria['projeto_cd'] ?>"/>
                            <input name="txtEtapa" id="txtEtapa" type="hidden" value="<?= $linhaDiaria['etapa_id'] ?>"/>
                            <input name="dtDiariaAnt" id="dtDiariaAnt" type="hidden"
                                   value="<?= $linhaDiaria['diaria_dt_saida'] ?>"/>
                            <input name="txtHoraCriacao" id="txtHoraCriacao" type="hidden"
                                   value="<?= $linhaDiaria['diaria_hr_criacao'] ?>"/>
                            <input name="txtValorRefAnt" id="txtValorRefAnt" type="hidden"
                                   value="<?= $linhaDiaria['diaria_valor_ref'] ?>"/>
                            ...
                            <input name="alterarRoteiro" id="alterarRoteiro" type="hidden"
                                   value="<?= $alterarRoteiro ?>"/>
                            <input name="txthorasAcesso" id="txthorasAcesso" type="hidden" value="<?= $HoraAcesso ?>"/>
                            <input name="txtBeneficiarioTemp" id="txtBeneficiarioTemp" type="hidden"
                                   value="<?= $linhaDiaria['diaria_beneficiario'] ?>"/>
                            <?php include "../Include/Inc_Linha.php" ?>
                            <?php
                            if ($MensagemErroBD != "") {
                                ...
                                <tr>
                                    <td height="21" align="right">
                                        <input type="button" style="width:70px"
                                               onClick="Javascript:GravarFormDiaria(document.Form);" name="btnGravar"
                                               id="btnGravar" class="botao" value="Gravar"/>&nbsp;&nbsp;&nbsp;
                                        <input type="button" style="width:70px"
                                               onClick="JavaScript:window.location.href='<?= $PaginaLocal ?>Inicio.php';"
                                               name="btnConsultar" class="botao" value="Voltar"/>
                                    </td>
                                </tr>
                            </table>
