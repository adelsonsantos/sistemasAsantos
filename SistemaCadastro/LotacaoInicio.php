...
<!--
	...
	function FiltrarForm(frm)
	{
		...
		frm.action = "LotacaoInicio.php?acao=buscar";
		frm.submit();
	}
	...
	function ExcluirForm(frm, checkbox)
	 {
		...
		frm.action="LotacaoExcluir.php?excluirMultiplo=1";
		frm.submit();
	 }
	...
	function AlterarForm(frm, checkbox)
	 {
		...
		frm.action="LotacaoCadastrar.php?acao=consultar";
		frm.submit();
	 }
                                ...
                                <td>
                                    <table border="0" cellpadding="1" cellspacing="1">
                                        <tr height="20" class="GridPaginacaoRegistroCabecalho">
                                            ...
                                            <td width="167" align="left">&nbsp;&Oacute;rg&atilde;o</td>
                                            <td width="471" align="left">&nbsp;Lota&ccedil;&atilde;o</td>
...
<?
										...
										{       $linha=pg_fetch_assoc($rsConsulta,$qtdIndice);
													    ...
													    $LotacaoCodigo			= $linha['lotacao_id'];
														$LotacaoOrgao			= $linha['orgao_ds'];
...
<?
														echo "<td>&nbsp;" .$LotacaoOrgao. "</td>";
														echo "<td>&nbsp;" .$LotacaoDescricao. "</td>";
														echo "<td align='center'><a href=LotacaoInicio.php?acao=alterarStatus&cod=".$LotacaoCodigo. "&status="
                                                              .$LotacaoStatusCod. "><font color='#065387'>" .$LotacaoStatus. "</font></a></td>"	;
														echo "</tr>";
