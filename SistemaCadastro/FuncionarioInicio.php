    ...
    <head>
        ...
        <script language="javascript">
            ...
            function FiltrarForm(frm)
            {
                ...
                frm.action = "FuncionarioInicio.php?acao=buscar";
                frm.submit();
            }
            ...
            {
                frm.txtFiltro.value = "";
                frm.action = "FuncionarioInicio.php";
                frm.submit();
            }
                        ...
                        <table align="left" width="990" cellspacing="0" cellpadding="0" border="0">
                            <tr>
                                ...
                                <td valign="top" align="left" width="800">
                                    ...
                                    <?php include "../Include/Inc_Linha.php"?>
                                    <?php include "../Include/Inc_Pesquisa_Validados.php"?>
                                    <?php include "../Include/Inc_Linha.php"?>
                                        ...
                                        {       
                                            ...
                                            echo "<tr class='dataField' onMouseOver=javascript:this.style.backgroundColor='#cccccc' onMouseOut=javascript:this.style.backgroundColor='#f2f2f2'>";                                                       
                                                ...
                                                else
                                                {
                                                    ...
                                                    echo "<td width='20' align='center'><img src='../Icones/ico_alterar_off.png' alt='Editar' border='0'/></td>";
                                                    echo "<td width='20' align='center'><img src='../Icones/ico_excluir_off.png' alt='Excluir' border='0'/></td>";
                                                }
                                                        
                                                echo "<td height='20'>" .$Matricula. "</td>";

                                                If ($Confirmado == "0")
                                                {
                                                    echo "<td height='20'><font color=#ff0000>" .$Nome. "</font></td>";
                                                }
                                                Else
                                                {
                                                ...
                                                echo "<td height='20' align='center'>".$EstruturaAtuacao. "</td>";
                                                if($_SESSION['TipoUsuario'] != '32')
                                                {
                                                    echo "<td height='20' align='center'><a href=FuncionarioInicio.php?acao=alterarStatus&cod=".$Codigo. "&status=" .$StatusNumero. "><font color='#065387'>".$StatusNome. "</font></a></td>";
                                                }
                                                else
                                                {
