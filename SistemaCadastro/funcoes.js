...
//HabCamposLocal
function HabCamposLocal() {

  if (document.getElementById('coord').checked) 
  {
      document.getElementById('campo_coordenadoria_usu').style.display = "";	
  }

  if (document.getElementById('sede').checked) 
  {
      document.getElementById('campo_coordenadoria_usu').style.display = "none";		      
  }    
}
