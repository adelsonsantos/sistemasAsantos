                    ...
                    <td valign="top" align="left">
                        ...
                        <table cellpadding="2" cellspacing="2" border="0" width="800" class="TabModulo">
                            <tr>
                                ...
                                <td align="left" class="titulo_pagina">Confirma exclusão do(s) registro(s) abaixo?</td>
                            	...
                            	<td>
                                    <table width="798" border="0" cellpadding="0" cellspacing="1">
                                        <tr height="21" class="dataLabel">
                                            ...
                                            <td width="378" align="center">Descrição</td>
...
<?
										...
										If ($ExcluirCheckbox == 1)
                                        {
											...
											$sqlConsulta = "SELECT * FROM seguranca.acao se, seguranca.sistema si WHERE (se.sistema_id = si.sistema_id)
                                                           AND acao_id IN (".$codCheckbox. ") ORDER BY UPPER(sistema_nm), UPPER(acao_ds)";
