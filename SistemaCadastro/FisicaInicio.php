...
<!--
	...
	function FiltrarForm(frm)
	{
		...
		frm.action = "FisicaInicio.php?acao=buscar";
		frm.submit();
	}
	...
	function ExcluirForm(frm, checkbox)
	 {
		...
		frm.action="FisicaExcluir.php?excluirMultiplo=1";
		frm.submit();
	...
	function AlterarForm(frm, checkbox)
	 {
		...
		frm.action="FisicaCadastrar.php?acao=consultar";
		frm.submit();
	 }
                                ...
                                <td>
                                    <table border="0" cellpadding="1" cellspacing="1">
                                        <tr height="20" class="GridPaginacaoRegistroCabecalho">
                                            ...
                                            <td width="538" align="left">&nbsp;Nome</td>
                                            <td width="120" align="center">CPF</td>
...
<?
														...
														echo "<td class='GridPaginacaoLink' align='center'>" .$CPF. "</td>";
														echo "<td class='GridPaginacaoLink' align='center'><a href=FisicaInicio.php?acao=alterarStatus&cod=".$Codigo."&status=".$StatusNumero."><font color='#065387'>".$StatusNome."</font></a></td>";
														echo "</tr>";
