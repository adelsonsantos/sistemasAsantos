...
<!--
	...
	function GravarForm(frm)
	{
		...
		{
			alert("Campo NOME DO ÓRGÃO em Branco.");
			frm.txtOrgao.focus();
			frm.txtOrgao.style.backgroundColor='#B9DCFF';
			return false;
		}

		if (frm.txtCodigo.value == "")
			frm.action = "OrgaoCadastrar.php?acao=incluir";
		else
			frm.action = "OrgaoCadastrar.php?acao=alterar";
                        	...
                        	<tr>
                            	<td>
                                    <table width="798" border="0" cellpadding="0" cellspacing="1">
                                        <tr height="21">
                                            <td class="dataLabel">&nbsp;Nome do &Oacute;rg&atilde;o</td>
                                        </tr>
                                        <tr height="21">
                                            <td class="dataField">&nbsp;<input name="txtOrgao" maxlength="100" type="text" value="<?=$OrgaoDescricao?>" style=" width:265px;">&nbsp;*</td>
                                        </tr>
                                    </table>
 								</td>
                        	</tr>
