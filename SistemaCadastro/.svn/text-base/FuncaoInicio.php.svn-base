...
<!--
	...
	function FiltrarForm(frm)
	{
		...
		frm.action = "FuncaoInicio.php?acao=buscar";
		frm.submit();
	}
	...
	function ExcluirForm(frm, checkbox)
	 {
		...
		frm.action="FuncaoExcluir.php?excluirMultiplo=1";
		frm.submit();
	 }
	...
	function AlterarForm(frm, checkbox)
	 {
		...
		frm.action="FuncaoCadastrar.php?acao=consultar";
		frm.submit();
	 }
                                ...
                                <td>
                                    <table border="0" cellpadding="1" cellspacing="1">
                                        <tr height="20" class="GridPaginacaoRegistroCabecalho">
                                            ...
                                            <td width="638" align="left">&nbsp;Fun&ccedil;&atilde;o</td>
...
<?
														echo "<td class='GridPaginacaoLink'>&nbsp;".$FuncaoDescricao. "</td>";
														echo "<td class='GridPaginacaoLink' align='center'><a href=FuncaoInicio.php?acao=alterarStatus&cod=".$FuncaoCodigo. "&status=".$FuncaoStatusCod. "><font color='#065387'>".$FuncaoStatus. "</font></a></td>";
														echo "</tr>";
                                          $qtdIndice++;
                                             }
