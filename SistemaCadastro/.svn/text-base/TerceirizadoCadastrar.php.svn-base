...
<script language="javascript" src="JavaScript/FormTerceirizado.js"></script>
            ...
            <table align="left" width="990" cellspacing="0" cellpadding="0" border="0">
                <tr>
                    ...
                    <td valign="top" align="left">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <table cellpadding="0" width="100%" cellspacing="0" border="0" id="aba3_off">
                                                    <tr>
                                                        <td width="7" align="left" background="../Imagens/bgaba_off.gif"><img src="../Imagens/aba_esq_off.gif" width="7" height="18"></td>
                                                        <td background="../Imagens/bgaba_off.gif" align="center"><a class="linktab" href="#" onClick="esconde_obj_id(aba1_on); mostra_obj_id(aba1_off); esconde_obj_id(formaba1); mostra_obj_id(aba2_off); esconde_obj_id(aba2_on); esconde_obj_id(formaba2); esconde_obj_id(aba3_off); mostra_obj_id(aba3_on); mostra_obj_id(formaba3);  mostra_obj_id(aba4_off); esconde_obj_id(aba4_on); esconde_obj_id(formaba4);">Contato</a></td>
                                                        <td width="7" align="right" background="../Imagens/bgaba_off.gif"><img src="../Imagens/aba_dir_off.gif" width="7" height="18"></td>
                                                    </tr>
                                                </table>
                                            </td>
                                           <td width="1"><img src="../Imagens/separa_aba.gif" width="1" height="18"></td>
                                            ...
                                            <td>
                                                <table cellpadding="0" width="100%" cellspacing="0" border="0" id="aba4_off">
                                                    <tr>
                                                        <td width="7" align="left" background="../Imagens/bgaba_off.gif"><img src="../Imagens/aba_esq_off.gif" width="7" height="18"></td>
                                                        <td background="../Imagens/bgaba_off.gif" align="center"><a class="linktab" href="#" onClick="esconde_obj_id(aba1_on); mostra_obj_id(aba1_off); esconde_obj_id(formaba1); mostra_obj_id(aba2_off); esconde_obj_id(aba2_on); esconde_obj_id(formaba2); mostra_obj_id(aba3_off); esconde_obj_id(aba3_on); esconde_obj_id(formaba3); esconde_obj_id(aba4_off); mostra_obj_id(aba4_on); mostra_obj_id(formaba4);">Informa&ccedil;&otilde;es Organizacionais</a></td>
                                                        <td width="7" align="right" background="../Imagens/bgaba_off.gif"><img src="../Imagens/aba_dir_off.gif" width="7" height="18"></td>
                                                    </tr>
                                                </table>
                                            </td>
                        ...
                        <div id="formaba4" style="display:none">  <?// inicio informacoes organizacionais ?>

						<?include "IncludeLocal/IncludeCadastroTerceirizadoInformacoesOrganizacionais.php"?>


                        </div>  <?// fim dos dados organizacionais ?>

                       	<table width="798" border="0" cellpadding="0" cellspacing="1">
							<tr height="21">
								<td class="dataLinha">(*) Campo obrigat&oacute;rio <font
									color="#FF0000"><b>
									<div id="erro"></div>
									</b></font></td>
								</tr>
                        ...
                        <input name="txtEstruturaOriginal" type="hidden" value="<?=$UnidadeFuncional?>">
