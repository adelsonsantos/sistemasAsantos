...
<!--
	...
	function FiltrarForm(frm)
	{
		...
		frm.action = "SistemaInicio.php?acao=buscar";
		frm.submit();
	}
	...
	function ExcluirForm(frm, checkbox)
	 {
		...
		frm.action="SistemaExcluir.php?excluirMultiplo=1";
		frm.submit();
	 }
                                ...
                                <td>
                                    <table border="0" cellpadding="1" cellspacing="1">
                                        <tr height="20" class="GridPaginacaoRegistroCabecalho">
                                            ...
                                            <td width="391" align="center">&nbsp;Descri&ccedil;&atilde;o</td>
                                            <td width="90" align="center">&nbsp;&Iacute;cone</td>
...
<?
										...
										{       $linha=pg_fetch_assoc($rsConsulta,$qtdIndice);
														...
														$numCodigo			= $linha['sistema_id'];
														$strDescricao	   	= $linha['sistema_nm'];
														$strIcone			= $linha['sistema_icone'];
...
<?
														...
														If ($strIcone != "")
                                                        {
															echo "<td class='GridPaginacaoLink' align='center'><a href=''>Visualizar</a></td>";
                                                        }
                                                        Else
														{	echo "<td class='GridPaginacaoLink' align='center'>Não possui</td>";
                                                        }

														echo "<td class='GridPaginacaoLink' align='center'><a href=sistemaInicio.php?acao=alterarStatus&cod=".$numCodigo. "&status=" .$numStatus. "><font color='#065387'>".$strStatus."</font></a></td>";
